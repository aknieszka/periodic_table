...
--
-- Name: types type_pk; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties fk_constraint; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_constraint FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
